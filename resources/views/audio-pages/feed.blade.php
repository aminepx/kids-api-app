...
<table class="table w-75 mt-5 m-auto">
  ...
  <tr >
    ...
    <a href="{{route('addurl',['id'=>$audio['id']])}}"><button class="btn btn-info me-1">add</button></a>
    <a href="{{route('audiourl',['id'=>$audio['id']])}}"><button class="btn btn-success">show</button></a>   
  </td>
