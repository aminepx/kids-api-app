   ...
   <div class="form-group col-md-6 mt-5 offset-3">
    <div class="mt-5">
        <div class="form-floating mb-2">
          ...
          <div class="form-floating mb-2">
            <input type="text" class="form-control @error('page_type') is-invalid @enderror" name="page_type"  placeholder="page type">
            @error('page_type')
               <div class="alert alert-danger">{{$message}}</div> 
            @enderror
          ...
          <div class="form-floating mb-2">
            <input type="text" class="form-control @error('jsonurl') is-invalid @enderror" name="jsonurl"  placeholder="json url">
            @error('jsonurl')
               <div class="alert alert-danger">{{$message}}</div> 
            @enderror
